...
if show_domain: 
    ...
    if len(layers)<2:
        domain_plots.show(clf=clf, train_data=train_data, train_labels=train_labels, res=layers, 
                            plot_folder='./'+results_file+'/domain/', 
                            plot_fig = True, save_fig = False)
    else:
        domain_plots.show_resolutions(clf=clf, train_data=train_data, train_labels=train_labels, res=layers, 
                                        plot_folder='./'+results_file+'/domain/',
                                        plot_fig = True, save_fig = False)
